...
<html lang="en">
<head>
    <title>Code coverage report for lib/prompt.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">lib</a> prompt.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span></td><td class="text"><pre class="prettyprint lang-js">const inquirer = require('inquirer');
...
&nbsp;
      ...
      return location;<span class="branch-0 cbranch-no" title="branch not covered" ></span>
    })
    .then(location =&gt;
      ask({
        type: 'confirm',
    ...
    .then(answers =&gt; {
      ...
      if (locationOK) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
...
&nbsp;
      ...
      return ask({
        ...
        validate: input =&gt; {
          ...
          return path.isAbsolute(input);<span class="branch-0 cbranch-no" title="branch not covered" ></span>
        }
      }).then(lastAnswer =&gt; {
...
&nbsp;
        return finalAnswers;<span class="branch-0 cbranch-no" title="branch not covered" ></span>
