  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>144/146</span>
      </div>
      <div class='fl pad1y space-right2'>
...
tabtab.shell = (env = process.env) =&gt; {
  const shell = (env.SHELL <span class="branch-0 cbranch-no" title="branch not covered" >|| '')</span>.split('/').slice(-1)[0];
  return shell;<span class="branch-0 cbranch-no" title="branch not covered" ></span>
};
&nbsp;
/**
...
tabtab.install = (options = { name: '', completer: '' }) =&gt; {
  ...
  if (!name) <span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >throw new TypeError('options.name is required');</span></span>
  if (!completer) <span class="branch-0 cbranch-no" title="branch not covered" >throw new TypeError('options.completer is required');<span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ></span></span></span>
&nbsp;
 ...
 */
tabtab.parseEnv = (env) =&gt; {
  if (!env) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('parseEnv: You must pass in an environment object.');</span>
