...
<html lang="en">
<head>
    <title>Code coverage report for lib/utils/tabtabDebug.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/utils</a> tabtabDebug.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span></td><td class="text"><pre class="prettyprint lang-js">const debug = require('debug')('tabtab');
const fs = require('fs');
 ...
 */
const tabtabDebug = () =&gt; {
  if (process.env.TABTAB_DEBUG) <span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >{</span></span>
<span class="cstat-no" title="statement not covered" >    const stream = fs.createWriteStream(process.env.TABTAB_DEBUG, {</span>
<span class="cstat-no" title="statement not covered" >      flags: 'a+'</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    debug.log = <span class="fstat-no" title="function not covered" >(...args) =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >      args = args.map(arg =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        if (typeof arg === 'string') return arg;</span>
<span class="cstat-no" title="statement not covered" >        return JSON.stringify(arg);</span>
<span class="cstat-no" title="statement not covered" >      });</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      stream.write(`${util.format(...args)}\n`);</span>
<span class="cstat-no" title="statement not covered" >    };</span>
<span class="cstat-no" title="statement not covered" >  }</span>
};
&nbsp;
